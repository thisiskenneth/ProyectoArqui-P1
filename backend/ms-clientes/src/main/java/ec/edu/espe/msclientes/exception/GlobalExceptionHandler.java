package ec.edu.espe.msclientes.exception;
...
public class GlobalExceptionHandler {
    ...
    // Validacion de parametros (@PathVariable/@RequestParam con @Positive, etc.)
    ...
    // Id con tipo invalido (ej. /api/clients/abc cuando se espera un Long)
